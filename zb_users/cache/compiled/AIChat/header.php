...
<link rel="stylesheet" rev="stylesheet" href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/main.css?<?php  echo $themeinfo['modified'];  ?>" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/content.css?<?php  echo $themeinfo['modified'];  ?>" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/style/elementUI.css?<?php  echo $themeinfo['modified'];  ?>" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/fonts/element-icons.woff?<?php  echo $themeinfo['modified'];  ?>" type="text/css" media="all" />
...
<script src="<?php  echo $host;  ?>zb_system/script/vue.min.js?v=<?php  echo $version;  ?>"></script>

<script src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/script/elementUI.js"></script>
