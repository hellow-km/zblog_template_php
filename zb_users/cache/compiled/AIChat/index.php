...
<head>
    <?php  include $this->GetTemplate('AI/header');  ?>
</head>
...
<body>
    <div id="app">
        <div class="page">
            <div class="page-header"><?php  include $this->GetTemplate('AI/header2');  ?></div>
            <div class="page-main">
                <div class="page-side" style="width: 200px"><?php  include $this->GetTemplate('AI/side');  ?></div>
                <div class="page-content"><?php  include $this->GetTemplate('AI/content');  ?></div>
            </div>

            <div class="page-footer"><?php  include $this->GetTemplate('AI/footer');  ?></div>
        </div>
    </div>
</body>
