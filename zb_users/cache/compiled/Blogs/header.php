...
<link rel="shortcut icon" href="<?php  echo $host;  ?>zb_users/theme/Blogs/image/<?php Blogs_Get_Logo('favicon','ico'); ?>">
...
<script src="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/script/fancybox.min.js" type="text/javascript"></script>
<?php } ?>
<?php if ($zbp->Config('Blogs')->cblbiaoqian=='3' && $zbp->Config('Blogs')->cebianlanbj !== '3') { ?>
...
<![endif]-->
<link rel="stylesheet" id="font-awesome-four-css" href="<?php  echo $host;  ?>zb_users/theme/<?php  echo $theme;  ?>/fonts/fontawesome-all.css" type='text/css' media='all'/>
<?php  echo $header;  ?>
...
<?php } ?>
<?php  echo $zbp->Config('Blogs')->baidutongji;  ?>
</head>
...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header">
		<nav id="top-header">
			<div class="top-nav">
				<div id="user-profile">
				<?php  echo $zbp->Config('Blogs')->zuoshangjue;  ?>
				</div>	
				<div class="menu-youshangjiao-container">
					<ul id="menu-youshangjiao" class="top-menu"><?php  echo $zbp->Config('Blogs')->youshangjue;  ?></ul>
				</div>		
			</div>
		</nav><!-- #top-header -->
		<div id="menu-box">
				...
				<div class="logo-site">
					<<?php if ($type=='index') { ?>h1<?php }else{  ?>div<?php } ?> class="site-title">
						<a href="<?php  echo $host;  ?>" title="<?php  echo $name;  ?>-<?php  echo $title;  ?>">
							<img src="<?php  echo $host;  ?>zb_users/theme/Blogs/image/<?php Blogs_Get_Logo('logo','png'); ?>" width="220" height="50" alt="<?php  echo $name;  ?>-<?php  echo $title;  ?>" title="<?php  echo $name;  ?>-<?php  echo $title;  ?>"/>
...
<nav class="breadcrumb" <?php if ($zbp->Config('Blogs')->gonggaolan =='') { ?>style="height:15px;"<?php } ?>>
<?php if ($zbp->Config('Blogs')->gonggaolan !=='') { ?>	
<div id="scrolldiv">
	<div class="bull"></div>
		<div class="scrolltext">
			<ul style="margin-top: 0px;"><?php  echo $zbp->Config('Blogs')->gonggaolan;  ?></ul>
		</div>
</div> 
