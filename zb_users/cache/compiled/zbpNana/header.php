...
<link rel="shortcut icon" href="<?php  echo $host;  ?>zb_users/theme/zbpNana/image/<?php zbpNana_Get_Logo('favicon','ico'); ?>">
				...
				<div class="logo-site">
					<<?php if ($type=='index') { ?>h1<?php }else{  ?>div<?php } ?> class="site-title">
						<a href="<?php  echo $host;  ?>" title="<?php  echo $name;  ?>-<?php  echo $title;  ?>">
							<img src="<?php  echo $host;  ?>zb_users/theme/zbpNana/image/<?php zbpNana_Get_Logo('logo','png'); ?>" width="220" height="50" alt="<?php  echo $name;  ?>-<?php  echo $title;  ?>" title="<?php  echo $name;  ?>-<?php  echo $title;  ?>"/>
