                ...
                <div class="schico statefixed">
                    ...
                    <div class="schfixed">
                        <form method="post" name="search" action="<?php  echo $host;  ?>zb_system/cmd.php?act=search">
                            <input type="text" name="q" placeholder="<?php if ($zbp->Config('tpure')->PostSCHTXT) { ?><?php  echo $zbp->Config('tpure')->PostSCHTXT;  ?><?php }else{  ?><?php  echo $lang['tpure']['schtxt'];  ?><?php } ?>" class="schinput" autocomplete="off">
