...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if(isset($_POST['isCircle'])){
    ...
    $zbp->Config('toTop')->scrollHeight =$_POST['scrollHeight'];
...
<div id="divMain">
    ...
    <div id="divMain2">
        <form method="post" enctype="multipart/form-data">
            ...
            <div>
                <span>滚动超过多少高度时显示:</span>
                <input type="number" name="scrollHeight"
                    value="<?php echo $zbp->Config('toTop')->scrollHeight??"200";?>" id="opt-scrollHeight">
            </div>
