...
<div id="divMain">
	...
	<?php Blogs_SubMenu($act);?>
     <a href="http://yigujin.wang/" target="_blank"><span class="m-right">技术支持</span></a>
    </div>
	<div id="divMain2"> 
	<?php if ($act == 'tpsz') { ?>
...
<table name="form1" width="100%" style="padding:0;margin:0;" cellspacing="0" cellpadding="0" class="tableBorder">
	<tr><td>
		<p>1、这款zblogPHP免费响应式博客主题Blogs，之所以命名为Blogs，是因为这款主题专门为博客设计的，没有其他 CMS杂志布局和图片布局，是一款纯粹的博客主题。</p>
		<p>2、Blogs主题支持一键切换博客布局和侧边栏布局（组合起来共有12种布局），还支持一键切换颜色风格。</p>
		<p>3、Blogs主题发布页和使用说明，请移步到 <a href="https://www.yigujin.cn/blogs2018/" target="_blank">主题使用说明</a> 查阅和参考 <a href="http://yigujin.wang/post/7.html" target="_blank">ZBlogPHP新手入门教程</a> 学习</p>
		<p>4、启用主题后模块中的控制面板、搜索、最近发表、最新留言、标签列表、作者列表等模块已经重建过，所以需要直接编辑提交方可生效。</p>
		<p>5、启用主题后，请根据Blogs主题配置相关项目进行设置，每一个选项都配有说明，部分项目也设置有默认内容，请根据内容修改即可。</p>
		<p>6、首页、分类目录页使用默认侧边栏（侧边栏1），文章页、页面使用侧边栏2。</p>
		<p>7、免费主题请保留主题版权及链接，如需去除版权请前往『 <a href="http://yigujin.wang/" target="_blank">Blogs主题</a> 』站点打赏，有问题也请在此站点留言反馈。</p>
	</td></tr>	
</table>
</form>
