...
function Blogs_Get_Logo($name='logo',$type='png'){
	global $host;
    $path = $host . 'zb_users/theme/Blogs/image/'.$name.'.'.$type;
	if (file_exists($path)){
        echo $name.'.'.$type;
    }else{
        echo $name.'1.'.$type;
...
$zbp->Config('Blogs')->gonggaolan = '<li class="scrolltext-title"><a href="http://yigujin.wang/post/5.html" target="_blank" rel="external nofollow noopener">阿里云最新促销优惠活动列表</a></li><li class="scrolltext-title"><a href="http://yigujin.wang/" target="_blank" rel="external nofollow noopener">ZBlogPHP主题Blogs主题演示站</a></li>';
$zbp->Config('Blogs')->youshangjue = '<li><a href="填写留言板地址">在线留言</a></li><li><a href="https://app.zblogcn.com/?id=1405" target="_blank" rel="nofollow noopener">Blogs主题</a></li>';
$zbp->Config('Blogs')->zuoshangjue = '您好，欢迎访问光临本站！';
$zbp->Config('Blogs')->chongfudianzan = '你已经点过一次了，可以了，谢谢！！！';
$zbp->Config('Blogs')->banquanxinxi = 'Copyright ©&nbsp; Blogs主题 &nbsp; | &nbsp;  <a href="http://beian.miit.gov.cn/" target="_blank" rel="nofollow noopener">暂无备案</a>';
$zbp->Config('Blogs')->yejiaoanniu1 = '<a target="_blank" rel="nofollow noopener" href="https://cloud.tencent.com/redirect.php?redirect=1014&cps_key=dff2c04a298934ed7ddce53912636bed&from=console">腾讯云服务器</a>';
$zbp->Config('Blogs')->yejiaoanniu2 = '<a href="https://chuangke.aliyun.com/invite?userCode=bfol0yvy" target="_blank" rel="nofollow noopener">阿里云代金券</a>';
$zbp->Config('Blogs')->yejiaoxiangguan = '<li><span class="post_spliter">•</span><a href="https://boke112.com/laoxuezhuji/" target="_blank" rel="nofollow noopener">虚拟主机</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/fuwuqi/" target="_blank" rel="nofollow noopener">服务器专题</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/baota/" target="_blank" rel="nofollow noopener">宝塔面板</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/wuyiyiba/" target="_blank" rel="nofollow noopener">5118专题</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/wps/" target="_blank" rel="nofollow noopener">WPS专题</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/upyun/" target="_blank" rel="nofollow noopener">又拍云专题</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/2043.html" target="_blank" rel="nofollow noopener">WordPress教程</a></li><li><span class="post_spliter">•</span><a href="https://boke112.com/6655.html" target="_blank" rel="nofollow noopener">ZBlogPHP教程</a></li>';
$zbp->Config('Blogs')->hdpsz_dm = '<li><a target="_blank" rel="nofollow noopener" href="https://app.zblogcn.com/?id=1405"><img src="zb_users/theme/Blogs/image/hdp/Blogs.jpg" alt="zblogPHP免费响应式博客主题Blogs" ></a><p class="slider-caption">zblogPHP免费响应式博客主题Blogs</p></li><li><a target="_blank" rel="nofollow noopener" href="https://boke112.com/laoxuezhuji/"><img src="zb_users/theme/Blogs/image/hdp/laoxuezhuji.jpg" alt="老薛主机7折优惠码boke112" ></a><p class="slider-caption">老薛主机7折优惠码boke112</p></li>';
