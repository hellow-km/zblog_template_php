    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            for (i = 0; i < pages.length; i = i + 1) {
                ...
                if (p) {
                    pages.total > pages.numberOfPages &&
                        pages.current > pages.numberOfPages &&
                        i == 0 &&
                        listContainer.append("<li><a>...</a></li>");
                    listContainer.append(p);
                    pages.numberOfPages == pages.length &&
                        i == pages.length - 1 &&
                        listContainer.append("<li><a>...</a></li>");
                }
            }
        ...
        buildPageItem: function (type, page) {
            ...
            switch (type) {
                case "first":
                    ...
                    title = this.options.tooltipTitles(
                        type,
                        page,
                        this.currentPage,
                    );
