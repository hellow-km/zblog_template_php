...
<script src="{$host}zb_users/theme/{$theme}/script/vue.min.js"></script>

<link rel="stylesheet" rev="stylesheet" href="{$host}zb_users/theme/{$theme}/style/element-plus.css" type="text/css" />

<script src="{$host}zb_users/theme/{$theme}/script/element-plus.js"></script>



<script src="{$host}zb_users/theme/{$theme}/script/api.js"></script>
