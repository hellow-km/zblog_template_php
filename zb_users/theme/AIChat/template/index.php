...
<body>
    <div id="app">
        <div class="page">
            <div class="page-header">{template:AI/header2}</div>
            <div class="page-main">
                <div class="page-side" style="width: 200px">{template:AI/side}</div>
                <div class="page-content">{template:AI/content}</div>
            </div>

            <div class="page-footer">{template:AI/footer}</div>
        </div>
    </div>
</body>
...
var app = new Vue({
    ...
    methods: {
        ...
        appendMessage(message, sender) {
            ...
            img.src =
                "<?php echo $zbp->host; ?>zb_users/theme/AIChat/" +
