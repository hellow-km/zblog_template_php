...
{template:seo}
<link rel="shortcut icon" href="{$host}zb_users/theme/zbpNana/image/{php}zbpNana_Get_Logo('favicon','ico');{/php}">
				...
				<div class="logo-site">
					<{if $type=='index'}h1{else}div{/if} class="site-title">
						<a href="{$host}" title="{$name}-{$title}">
							<img src="{$host}zb_users/theme/zbpNana/image/{php}zbpNana_Get_Logo('logo','png');{/php}" width="220" height="50" alt="{$name}-{$title}" title="{$name}-{$title}"/>
							<span>{$name}</span>
						</a>
