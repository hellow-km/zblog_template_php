...
<div class="clear"></div>
<div class="site-info">{$zbp->Config('zbpNana')->banquanxinxi}<span class="footer-tag">&nbsp; | &nbsp; Theme by <a href="https://app.zblogcn.com/?id=1326"  target="_blank" title="zblogPHP免费响应式博客主题zbpNana">zbpNana</a>&nbsp; | &nbsp; Powered by <a href="http://www.zblogcn.com/" title="RainbowSoft Z-BlogPHP" target="_blank">Z-BlogPHP</a></span></div>
</div>
...
<img alt="公众号二维码" src="{$host}zb_users/theme/zbpNana/image/{php}zbpNana_Get_Logo('gongzhonghao','jpg');{/php}">
</div>
