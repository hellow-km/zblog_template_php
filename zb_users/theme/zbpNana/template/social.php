...
{if $zbp->Config('zbpNana')->wzds_kg=='1'}
		<span class="liubaixx">
		<div class="shang clr">	
			<a  title="好文！一定要打赏！" class="dashang" href="JavaScript:void(0)"><i class="fas fa-gift"></i>赞赏<span><img src="{$host}zb_users/theme/zbpNana/image/{php}zbpNana_Get_Logo('dashang','jpg');{/php}" alt="打赏二维码"></span></a>
		</div>
		</span>
		{/if}
