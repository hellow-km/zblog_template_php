...
function zbpNana_Get_Logo($name='logo',$type='png'){
	global $host;
    $path = $host . 'zb_users/theme/zbpNana/image/'.$name.'.'.$type;
    if (file_exists($path)){
        echo $name.'.'.$type;
    }else{
        echo $name.'1.'.$type;
...
$zbp->Config('zbpNana')->gonggaolan = '<li class="scrolltext-title"><a href="https://app.zblogcn.com/?id=1405" rel="bookmark" target="_blank">zblogPHP响应式主题Blogs免费发布啦</a></li><li class="scrolltext-title"><a href="https://app.zblogcn.com/?id=1326" rel="bookmark" target="_blank">zblogPHP响应式主题zbpNana发布啦</a></li>';
$zbp->Config('zbpNana')->youshangjue = '<li><a href="填写留言板地址">在线留言</a></li><li><a href="https://app.zblogcn.com/?id=1405">Blogs主题</a></li>';
$zbp->Config('zbpNana')->zuoshangjue = '您好，欢迎访问光临本站&nbsp;&nbsp;|&nbsp;<a href="填写后台登录地址" target="_blank">登录</a>';
...
$zbp->Config('zbpNana')->yejiaoxiangguan = '<li><span class="post_spliter">•</span><a href="https://app.zblogcn.com/?id=1405" target="_blank">Blogs主题</a></li><li><span class="post_spliter">•</span><a href="https://app.zblogcn.com/?id=1326" target="_blank">zbpNana主题</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/" target="_blank">zbpNana演示</a></li><li><span class="post_spliter">•</span><a href="http://yigujin.wang/post/451.html" target="_blank">老薛主机</a></li><li><span class="post_spliter">•</span><a href="https://promotion.aliyun.com/ntms/yunparter/invite.html?userCode=bfol0yvy" target="_blank">阿里云代金券</a></li><li><span class="post_spliter">•</span><a href="https://cloud.tencent.com/redirect.php?redirect=1025&cps_key=dff2c04a298934ed7ddce53912636bed&from=console" target="_blank">腾讯云代金券</a></li><li><span class="post_spliter">•</span><a href="https://app.zblogcn.com/?id=1326" target="_blank">zbpNana主题</a></li><li><span class="post_spliter">•</span><a href="https://app.zblogcn.com/?id=1405" target="_blank">Blogs主题</a></li>';
$zbp->Config('zbpNana')->hdpsz_dm = '<li><a target="_blank" href="https://app.zblogcn.com/?id=1405"><img src="zb_users/theme/Blogs/image/hdp/170626_Blogs.jpg" alt="zblogPHP清新响应式博客主题Blogs" ></a><p class="slider-caption">zblogPHP清新响应式博客主题Blogs</p></li><li><a target="_blank" href="https://app.zblogcn.com/?id=1326"><img src="zb_users/theme/Blogs/image/hdp/170425_zbpNana.jpg" alt="zblogPHP清新响应式主题zbpNana" ></a><p class="slider-caption">zblogPHP清新响应式主题zbpNana</p></li>';
