...
<link rel="stylesheet" rev="stylesheet" href="{$host}zb_users/theme/{$theme}/style/main.css?{$themeinfo['modified']}" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="{$host}zb_users/theme/{$theme}/style/content.css?{$themeinfo['modified']}" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="{$host}zb_users/theme/{$theme}/style/elementUI.css?{$themeinfo['modified']}" type="text/css" media="all" />

<link rel="stylesheet" rev="stylesheet" href="{$host}zb_users/theme/{$theme}/fonts/element-icons.woff?{$themeinfo['modified']}" type="text/css" media="all" />
