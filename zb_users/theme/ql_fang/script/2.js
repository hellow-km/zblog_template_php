...
var Swiper = function (a, b) {
    ...
    function f() {
        ...
        if (
            (b.keyboardControl && d(document, "keydown", i),
    ...
    function j(a) {
        ...
        if (a.detail) d = -a.detail;
            ...
            if (b.mousewheelControlForceToAxis)
                ...
                d =
                    Math.abs(a.deltaX) > Math.abs(a.deltaY)
                        ? -a.deltaX
                        : -a.deltaY;
        if (b.freeMode) {
            ...
            (new Date().getTime() - U > 60 &&
                (0 > d ? C.swipeNext() : C.swipePrev()),
                (U = new Date().getTime()));
        return (
    ...
    function m(a) {
        ...
        ((C.clickedSlideIndex = C.slides.indexOf(C.clickedSlide)),
            (C.clickedSlideLoopIndex =
                C.clickedSlideIndex - (C.loopedSlides || 0)));
    }
    function n(a) {
        return C.allowLinks
            ? void 0
    ...
    function p(a) {
        ...
        if (!Z || 1 === a.targetTouches.length) {
            ...
            ((C.touches.startX = C.touches.currentX = e),
                ...
                C.setWrapperTransition(0),
                (C.positions.start = C.positions.current =
        ...
        if (C.isTouched && !b.onlyExternal && (!Z || "mousemove" !== a.type)) {
            ...
            if (
                ("undefined" == typeof H &&
                    ...
                    (H = !!(
                        H ||
                        Math.abs(d - C.touches.startY) >
                            Math.abs(c - C.touches.startX)
                    )),
                "undefined" != typeof H ||
                    M ||
                    (H = !!(
            ...
            if (
                ...
                if (
                    (C.isMoved ||
                        ...
                        b.onTouchMoveStart &&
                            C.fireCallback(b.onTouchMoveStart, C)),
                    (C.isMoved = !0),
                    a.preventDefault
                        ? a.preventDefault()
                        : (a.returnValue = !1),
                    ...
                    if (
                        ...
                        var g =
                            (C.touches.current - C.touches.start) *
                                b.touchRatio +
                            (e() + C.positions.start);
                        f = (I + g) / I;
            ...
            if (((C.isMoved = !1), b.freeMode)) {
                if (b.freeModeFluid) {
                    ...
                    (-g > k &&
                        ...
                        0 !== C.velocity &&
                            (i = Math.abs(
                                (k - C.positions.current) / C.velocity,
                            )),
                        ...
                        b.momentumBounce &&
                            ...
                            C.wrapperTransitionEnd(function () {
                                $ &&
                                    (b.onMomentumBounce &&
                                        C.fireCallback(b.onMomentumBounce, C),
    ...
    function s(a) {
        ...
        while (
            !c &&
            a.parentElement &&
            -1 === a.className.indexOf(b.wrapperClass)
        );
        return (
            !c &&
    ...
    function u(a, c, d) {
        ...
        (C.updateActiveSlide(a),
            b.onSlideNext &&
                "next" === c &&
                C.fireCallback(b.onSlideNext, C, a),
            b.onSlidePrev &&
                "prev" === c &&
                C.fireCallback(b.onSlidePrev, C, a),
            b.onSlideReset &&
                "reset" === c &&
                C.fireCallback(b.onSlideReset, C, a),
            ("next" === c ||
                "prev" === c ||
    ...
    if (
        ...
        (C.browser.ie10 &&
            ...
            (C.touchEvents = {
                touchStart:
                    C.support.touch || !b.simulateTouch ? "touchstart" : N[0],
                touchMove:
                    C.support.touch || !b.simulateTouch ? "touchmove" : N[1],
                touchEnd:
                    C.support.touch || !b.simulateTouch ? "touchend" : N[2],
            }));
        for (var O = C.container.childNodes.length - 1; O >= 0; O--)
            if (C.container.childNodes[O].className)
                for (
                    var P = C.container.childNodes[O].className.split(/\s+/),
                        Q = 0;
                    Q < P.length;
                    Q++
                )
        ...
        ((C.wrapper = D),
                ...
                return (
                    (a.append = function () {
                        return (
                            b.loop
                                ? a.insertAfter(
                                      C.slides.length - C.loopedSlides,
                                  )
                    ...
                    (a.prepend = function () {
                        return (
                            b.loop
                                ? (C.wrapper.insertBefore(
                                      a,
                                      C.slides[C.loopedSlides],
                                  ),
                ...
                for (var d = 0; d < C.wrapper.childNodes.length; d++)
                    if (C.wrapper.childNodes[d].className)
                        for (
                            ...
                            f[i] === b.slideClass &&
                                C.slides.push(C.wrapper.childNodes[d]);
            ...
            (C.removeLastSlide = function () {
                return C.slides.length > 0
                    ? (b.loop
                          ? (C.slides[
                                C.slides.length - 1 - C.loopedSlides
                            ].remove(),
                            C.removeLoopedSlides(),
                            C.calcSlides(),
                            C.createLoop())
        ...
        ((C.callPlugins = function (a, b) {
            ...
            (C.init = function (a, c) {
                ...
                if (d !== C.width || e !== C.height || a) {
                                    ...
                                    ? ((C.wrapperLeft =
                                      ...
                                      (C.wrapperRight =
                                          (I -
                                              C.slides[
                                                  C.slides.length - 1
                                              ].getWidth(!0, b.roundLengths)) /
                                          2))
                                    : ((C.wrapperTop =
                                          (I -
                                              C.slides[0].getHeight(
                                                  !0,
                                                  b.roundLengths,
                                              )) /
                                          2),
                        ...
                        for (
                            f = M ? C.width / b.slidesPerView : C.width,
                                ...
                                b.offsetSlidesBefore > 0 &&
                                    (M
                                        ? (C.wrapperLeft =
                                              E * b.offsetSlidesBefore)
                                        : (C.wrapperTop =
                                              E * b.offsetSlidesBefore)),
                                b.offsetSlidesAfter > 0 &&
                                    (M
                                        ? (C.wrapperRight =
                                              E * b.offsetSlidesAfter)
                                        : (C.wrapperBottom =
                                              E * b.offsetSlidesAfter)),
                                b.offsetPxBefore > 0 &&
                                    (M
                                ...
                                parseFloat(i) > 0 &&
                                    (!b.cssWidthAndHeight ||
                                        "height" === b.cssWidthAndHeight) &&
                                    (m.style.width = i + "px"),
                                parseFloat(j) > 0 &&
                                    (!b.cssWidthAndHeight ||
                                        "width" === b.cssWidthAndHeight) &&
                                    (m.style.height = j + "px"),
                                k = 0,
                                C.snapGrid = [],
                                C.slidesGrid = [],
                    ...
                    (C.initialized
                        ? (C.callPlugins("onInit"),
                          b.onInit && C.fireCallback(b.onInit, C))
                ...
                (C.callPlugins("beforeResizeFix"),
                    ...
                    b.freeMode
                        ? C.getWrapperTranslate() < -e() &&
                          (C.setWrapperTransition(0),
                          C.setWrapperTranslate(-e()))
                        : (C.swipeTo(
                              b.loop ? C.activeLoopIndex : C.activeIndex,
                              0,
                              !1,
                          ),
                          b.autoplay &&
            ...
            (C.updateActiveSlide = function (a) {
                if (C.initialized && 0 !== C.slides.length) {
                    ((C.previousIndex = C.activeIndex),
                        "undefined" == typeof a &&
                            (a = C.getWrapperTranslate()),
                        a > 0 && (a = 0));
                    var c;
                    if ("auto" === b.slidesPerView) {
                        if (
                            ((C.activeIndex = C.slidesGrid.indexOf(-a)),
                            C.activeIndex < 0)
                        ) {
                            for (
                                c = 0;
                        ...
                        C.activeIndex = Math[
                            b.visibilityFullFit ? "ceil" : "round"
                        ](-a / E);
                    if (
                        ...
                        if ((C.calcVisibleSlides(a), C.support.classList)) {
                            ...
                            C.slides[C.activeIndex].classList.add(
                                b.slideActiveClass,
                            );
                        } else {
                            ...
                            for (c = 0; c < C.slides.length; c++)
                                ((C.slides[c].className = C.slides[c].className
                                    ...
                                    C.visibleSlides.indexOf(C.slides[c]) >= 0 &&
                                        (C.slides[c].className +=
                                            " " + b.slideVisibleClass));
                            C.slides[C.activeIndex].className +=
                                " " + b.slideActiveClass;
                        }
                        if (b.loop) {
                        ...
                        if (0 !== e.length) {
                            ...
                            if (b.paginationAsRange) {
                                ...
                                for (h = 0; h < C.visibleSlides.length; h++) {
                                    var j =
                                        C.slides.indexOf(C.visibleSlides[h]) -
                                        g;
                                    (b.loop &&
                                        0 > j &&
                                        (j =
        ...
        ((C.startAutoplay = function () {
            ...
            (C.stopAutoplay = function (a) {
                if (C.support.transitions) {
                    ...
                    (_ && clearTimeout(_),
                        ...
                        b.onAutoplayStop &&
                            C.fireCallback(b.onAutoplayStop, C));
                } else
                    (ab && clearInterval(ab),
                        (ab = void 0),
                        C.callPlugins("onAutoplayStop"),
            ...
            (C.createLoop = function () {
                if (0 !== C.slides.length) {
                    ...
                    for (
                        ...
                        (a < C.loopedSlides ||
                            a >= C.slides.length - C.loopedSlides) &&
            ...
            (C.fixLoop = function () {
                ...
                C.activeIndex < C.loopedSlides
                    ? ((a =
                          C.slides.length - 3 * C.loopedSlides + C.activeIndex),
                      C.swipeTo(a, 0, !1))
                    : (("auto" === b.slidesPerView &&
                          C.activeIndex >= 2 * C.loopedSlides) ||
                          C.activeIndex >
                              C.slides.length - 2 * b.slidesPerView) &&
            ...
            (C.loadSlides = function () {
                ...
                ((C.wrapper.innerHTML = a),
                    ...
                    b.loader.loadAllSlides ||
                        C.wrapperTransitionEnd(C.reloadSlides, !0));
            }),
            (C.reloadSlides = function () {
                ...
                if (!(0 > c || c > a.length - 1)) {
                    ...
                    var d = Math.max(
                            0,
                            c - b.slidesPerView * b.loader.surroundGroups,
                        ),
                        e = Math.min(
                            c +
                                b.slidesPerView *
