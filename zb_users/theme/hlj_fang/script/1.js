...
var Swiper = function (selector, params) {
    ...
    _this.fireCallback = function () {
        ...
        if (Object.prototype.toString.call(callback) === "[object Array]") {
            ...
            Object.prototype.toString.call(callback) === "[object String]"
        ) {
        ...
        if (params.slidesPerView === "auto") {
            ...
            if (isH) {
                ...
                if (
                    ...
                    params.cssWidthAndHeight === "height"
                ) {
                    wrapper.style.width = slidesWidth + "px";
                }
                if (
                    !params.cssWidthAndHeight ||
                    params.cssWidthAndHeight === "width"
                ) {
        ...
        if (!params.freeMode) {
            ...
            if (params.autoplay) {
                if (
                    ...
                    typeof autoplayTimeoutId !== "undefined"
                ) {
    ...
    function initEvents() {
        ...
        var eventTarget =
            params.eventTarget === "wrapper" ? _this.wrapper : _this.container;
        //Touch Events
    ...
    function onTouchEnd(event) {
        ...
        if (params.freeMode) {
            if (params.freeModeFluid) {
                ...
                var bounceAmount =
                    Math.abs(_this.velocity) * 20 * params.momentumBounceRatio;
        ...
        if (params.slidesPerView === "auto") {
            ...
            for (var i = 0; i < _this.slides.length; i++) {
                _slideSize = isH
                    ? _this.slides[i].getWidth(true, params.roundLengths)
                    : _this.slides[i].getHeight(true, params.roundLengths);
    ...
    function swipeToPosition(newPosition, action, toOptions) {
        ...
        if (_this.support.transitions || !params.DOMAnimation) {
            ...
            var currentPosition = _this.getWrapperTranslate();
            var animationStep = Math.ceil(
                ((newPosition - currentPosition) / speed) * (1000 / 60),
            );
        ...
        if (
            (action === "next" || action === "prev" || action === "to") &&
            toOptions.runCallbacks === true
        )
    ...
    _this.updateActiveSlide = function (position) {
        ...
        if (_this.support.classList) {
            ...
            var inViewClassRegexp = new RegExp(
        ...
        if (params.loop) {
            ...
            if (_this.activeLoopIndex >= _this.slides.length - ls * 2) {
                _this.activeLoopIndex =
                    _this.slides.length - ls * 2 - _this.activeLoopIndex;
            }
    ...
    _this.updatePagination = function (position) {
        ...
        if (params.paginationAsRange) {
            ...
            for (j = 0; j < _this.visibleSlides.length; j++) {
                var visIndex =
                    _this.slides.indexOf(_this.visibleSlides[j]) - indexOffset;

                if (params.loop && visIndex < 0) {
                    visIndex =
                        _this.slides.length - _this.loopedSlides * 2 + visIndex;
                }
                if (
                    params.loop &&
                    visIndex >= _this.slides.length - _this.loopedSlides * 2
                ) {
                    visIndex =
                        _this.slides.length - _this.loopedSlides * 2 - visIndex;
    ...
    _this.createLoop = function () {
        ...
        if (params.slidesPerView === "auto") {
            ...
            _this.loopedSlides =
                Math.floor(params.slidesPerView) + params.loopAdditionalSlides;
        }
    ...
    _this.fixLoop = function () {
        ...
        //Fix For Positive Oversliding
            ...
            _this.activeIndex > _this.slides.length - params.slidesPerView * 2
        ) {
            newIndex =
    ...
    _this.loadSlides = function () {
        ...
        var slidesToLoad = params.loader.loadAllSlides
            ? slides.length
    ...
    _this.reloadSlides = function () {
        ...
        if (params.loader.logic === "reload") {
            ...
            for (i = firstIndex; i <= lastIndex; i++) {
                slidesHTML +=
                    params.loader.slidesHTMLType === "outer"
                        ? slides[i]
                        : "<" +
                          params.slideElement +
                          ' class="' +
...
Swiper.prototype = {
    ...
    setTranslate: function (el, translate) {
        ...
        var transformString = this.support.transforms3d
